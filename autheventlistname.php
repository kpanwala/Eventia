...
<div>
   <h1 style="color:white; text-align:center;">Order by Event name</h1>
</div>

    <?php
$sql="SELECT location_city,address,artist,event_name,photo,date,time,type from events order by event_name";
