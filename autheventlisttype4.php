...
<div>
   <h1 style="color:white; text-align:center;">Sort by Dance</h1>
</div>
    <?php
...
$sql="SELECT location_city,address,artist,event_name,photo,date,time,type,price,event_id from events where type='Dancing'";
$result=$conn->query($sql);
