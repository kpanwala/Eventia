...
<div>
   <h1 style="color:white; text-align:center;">Sort by Dancing Events</h1>
</div>
    <?php
$sql="SELECT location_city,address,artist,event_name,photo,date,time,type from events where type='Dancing'";
