...
<div>
   <h1 style="color:white; text-align:center;">Sort by Songs</h1>
</div>
    <?php
...
$sql="SELECT location_city,address,artist,event_name,photo,date,time,type,price,event_id from events where type='Singing'";
$result=$conn->query($sql);
