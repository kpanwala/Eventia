			...
			<div class="wrap-login100 p-t-30 p-b-50" >
				...
				<form class="login100-form validate-form p-b-33 p-t-5" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
					...
					<div class="container-login100-form-btn m-t-32">
						<input type="submit" id="submit" name="submit" value="Log in" class="login100-form-btn">  
					</div>
		
					<p style="margin-left:10vw; margin-top:4vh;">New User? <a href="signUp.php" style="color:black;">Sign Up</a></p>
