...
<div>
   <h1 style="color:white; text-align:center;">Sort by Comedy</h1>
</div>
    <?php
...
$sql="SELECT location_city,address,artist,event_name,photo,date,time,type,price,event_id from events where type='Comedy'";
$result=$conn->query($sql);
